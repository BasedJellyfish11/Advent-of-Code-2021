...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname d1q1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor mixed-fraction #f #t none #f () #t)))
(define input
  (list 103
        112
        111
